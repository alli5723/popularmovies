...
public class MoviesContractUnitTest {
    @Test
    public void inner_class_exists() throws Exception{
        Class[] innerClasses = MoviesContract.class.getDeclaredClasses();
        assertEquals("There should be an inner class in our contract class", 1, innerClasses.length);
    }
    ...
    public void inner_class_type_correct()throws Exception{
        ...
        assertTrue("Inner Class should implement Base Column interface", BaseColumns.class.isAssignableFrom(entryClass));
